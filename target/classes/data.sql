...
INSERT INTO CONTACT_TABLE(id, Active, first_Name,last_Name,email,account1_id) VALUES
    (99997, true, 'Christian', 'Brandl', 'brandl.christian@jku.at',99998),
    (99998, true, 'Marlon','Boler','boler.marlong@jku.at',99998),
    (99999, true, 'Natascha','Ayanfo', 'Ayanfo.Natascha@jku.at',99998);
